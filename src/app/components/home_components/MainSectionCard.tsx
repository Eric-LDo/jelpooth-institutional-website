...
const MainSectionCard: React.FC<Service> = ({ id, title, text, icon }) => {
  return (
    <Motion >
      <div key={id} className='border-2 border-black dark:border-white rounded-2xl m-3 bg-gray-950 flex flex-col justify-center items-center p-3 mb-5 text-center h-60'>
